  ...
  return (
    <div className="bg-white min-h-screen px-8 py-6">
      ...
      <div className="flex items-center gap-4 mt-6">
        <span className="text-3xl font-bold cursor-pointer" onClick = {() => {navigate("/")}} >←</span>
      ...
      <div className="mt-12 flex gap-10">
        ...
        <div className="w-6/12 border rounded-xl p-8 shadow-sm">
          ...
          <div className="mt-6 flex gap-4 items-center justify-center">
            <button className="px-6 py-2 bg-yellow-400 rounded-md font-semibold hover:bg-yellow-500" onClick = {() => alert("OTP sent successfully to your registered mobile number") } >
              Send OTP
            </button>
